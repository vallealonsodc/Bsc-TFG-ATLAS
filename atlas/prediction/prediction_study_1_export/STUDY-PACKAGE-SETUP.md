...
The setup script below is used to install the **PLP** package. You will need to modify this setup script as follows:
                                                                                              
- Set the `projectRootFolder` variable to the directory specific to your environment. In this example we are using `C:/PLP`. This root folder will serve a few purposes:
...
download.file("https://raw.githubusercontent.com/ohdsi-studies/PLP/main/renv.lock", "renv.lock")
...
# finally install the PLP package
...
You can safely continue by pressing 'y' after this prompt since the renv.lock file is downloaded from the **PLP** GitHub code repository. Once the installation is complete, you may need to restart R (if you are working outside of RStudio) and you should see this message:

````
Project 'C:/PLP' loaded. [renv 0.x.y]
````
