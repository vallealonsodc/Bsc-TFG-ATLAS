...
#devtools::source_url("https://raw.github.com/ohdsi/PLP/issue242/extras/createDevelopmentPackageFunctions.R")
...
createDevelopmentPackage(
  jsonList = jsonList, 
  baseUrl = baseUrl,
  #skeletonLocation = 'D:/GitHub/PLP', 
  skeletonUrl = "https://github.com/ohdsi/PLP/archive/master.zip",
