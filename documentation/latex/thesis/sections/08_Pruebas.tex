...
\begin{figure}[H]
    ...
    \captionof{table}{Tabla de resultados. Extraída de \cite{nunez2023benchmarking}}
...
%Sí porque aqui son resultados concretos del estudio. En la sección de resultados serán resultados compeltos del TFG
