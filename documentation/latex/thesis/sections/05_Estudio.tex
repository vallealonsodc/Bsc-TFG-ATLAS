...
Sin embargo, es importante recalcar que tanto ATLAS (como algunas otras herramientas de OHDSI) no consiste en un archivo ejecutable aislado sino de una aplicación contenida y dependiente de un ecosistema completo basado en la web. La dependencia principal y red que sostiene a ATLAS es la \textbf{WebAPI}.
